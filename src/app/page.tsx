          ...
          <div className="flex flex-col items-center">
            ...
            >
              <div className="relative w-90 h-90">
                <div className="absolute right-0 top-0 w-64 h-64 bg-blue-500 rounded-full blur-3xl animate-pulse" />
                <div className="absolute left-0 bottom-0 w-64 h-64 bg-blue-600 rounded-full blur-3xl animate-pulse" />
                <img 
                  src="/logo2.png" 
