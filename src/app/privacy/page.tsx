        ...
        <div style={{maxWidth:"100ch"}} className="container mx-auto px-4 md:px-4 py-8 md:py-12 lg:py-16">
          ...
          <div className="space-y-6 text-base md:text-lg leading-relaxed text-justify">
            <p>
              ...
              >
                https://www.re-verse.in
              </a>.
              You may browse certain sections of our platform without registering; however, please note that we do not offer any product or service under this platform outside India. Your personal data will primarily be stored and processed in India.
              By visiting our platform, providing your information, or availing of any product or service offered on it, you expressly agree to be bound by the terms and conditions of this Privacy Policy, the Terms of Use, and the applicable service/product terms and conditions. You also agree to be governed by the laws of India, including those related to data protection and privacy.
              If you do not agree with these terms, please refrain from using or accessing our platform.
            </p>
  
            <p>
              If you have a question regarding this Privacy Notice or data protection
              at Re-Verse you can reach out to our Privacy Team by sending an email to{" "}
              <a
              ...
              . Please also send an email to our Privacy Team if you would like to
              request data access or data deletion, or in order to exercise other
              data protection rights provided in Art. 15-22 GDPR, including
              withdrawal of consent to marketing, opt out from newsletter etc. For
              more information see the sections Which data protection rights do I
              have? and Contact.
            </p>
            ...
            <p>
              We provide all users with the option to opt out of receiving non-essential communications, such as promotional or marketing-related messages, after setting up an account.
            </p>
  
            <h3 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4">
              4. Use of Children Information
            </h3>
            <p>
              The use of our platform is restricted to individuals who can form a legally binding contract under the Indian Contract Act, 1872. We do not knowingly solicit or collect personal data from children under the age of 18 years. If you have provided personal data of children under 18 years, you confirm that you have the authority to do so and consent to our use of such information in accordance with this Privacy Policy.
            </p>
