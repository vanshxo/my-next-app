export default function returns() {
    return (
      ...
      <ul>
        ...
        <li>
          Users must provide accurate, complete, and detailed shipping addresses (including landmarks, if applicable) 
      ...
      <ul>
        <li>
          Upon successful order placement, users will receive a tracking ID via email and SMS once the product is handed 
        ...
        <li>
          Most orders are delivered within 7-12 working days across India. If the user remains unavailable for delivery 
          after multiple attempts, Re-verse reserves the right to cancel the order.
        </li>
      </ul>
      ...
      <p>
        In such cases, Re-verse will make reasonable attempts to inform users via registered email or mobile number. 
        However, Re-verse will not compensate for mental distress or tort claims arising from delivery delays.
      </p>
      </div>
